...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === maskhan.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = maskhan.user.id.split(':')[0]+'@s.whatsapp.net'
}
